        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4">
            ...
            <Link href="/dashboard" className="flex items-center gap-2 group">
              <div className="w-8 h-8 signature-gradient rounded flex items-center justify-center text-white font-bold text-xs shadow-lg shadow-primary/20 transition-transform group-hover:scale-105">A</div>
              <span className="text-xl font-bold text-on-surface tracking-tight italic hidden sm:block">Applyrd</span>
            </Link>
          </div>
