...
export default function KanbanBoard({ initialJobs = [], hasJobs = false }: { initialJobs?: any[], hasJobs?: boolean }) {
  ...
  return (
    <section>
      ...
      <ScrollArea className="w-full whitespace-nowrap rounded-md border-0 h-[calc(100vh-320px)]">
            ...
            >
              ...
              <div className="flex flex-col gap-4 overflow-y-auto pr-1 min-h-[50px]">
                {columnJobs.map(job => (
                  ...
                  >
                    <Card className="p-5 bg-surface-container-lowest border-none transition-all shadow-sm hover:shadow-xl hover:shadow-primary/5">
                      ...
                      <p className="text-[11px] text-muted-foreground font-medium mb-5">{job.company}</p>
